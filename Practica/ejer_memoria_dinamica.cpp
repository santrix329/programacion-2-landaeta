...
int* crearArreglo(int tamanio) {
    ...
    if(tamanio <= 0) {
        cout << " El tamanio no es valido " << endl;
        return nullptr;
    }
    else {
        int* pTamanio = new int[tamanio];
        if(pTamanio == nullptr) {
...
void mostrarArreglo(int* arreglo, int tamanio) {
    ...
    for ( int i = 0 ; i < tamanio; i ++) {
        cout << " Elvalor del arreglo en la posicion: " << i << " es " << arreglo[i] << endl;
    }
}
...
int encontrarMayor(int* arreglo, int tamanio) {
    if( arreglo == nullptr || tamanio <= 0) {
        cout << " Arreglo nulo o vacio " << endl;
        return 0; 
    }
    int numero_mayor = arreglo[0];
    for(int i = 0; i < tamanio; i++) {
    ...
    return numero_mayor; // Placeholder
}
...
void liberarArreglo(int*& arreglo) {
    if( arreglo == nullptr) {
        cout <<" El arreglo ya esta liberado" << endl;
        return;
